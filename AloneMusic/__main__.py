...
async def init():
    ...
    LOGGER("AloneMusic").info(
        ""
    )
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("AloneMusic").info("Stopping Alone Music Bot...")
